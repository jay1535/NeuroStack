  ...
  return (
    <div className="relative min-h-screen flex flex-col md:flex-row bg-white dark:bg-black text-black dark:text-white">
      ...
      <Link href="/" className="fixed top-8 left-0 z-50">
        <div className="pl-6 pr-5 py-2 rounded-r-full bg-purple-700 dark:bg-rose-500 text-white text-sm font-semibold shadow-lg hover:pl-8 transition-all">
          ← Back
        </div>
      </Link>
        ...
        <div className="w-full max-w-md rounded-3xl p-8 bg-white dark:bg-black border border-black/10 dark:border-white/10 shadow-sm">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              disabled={loading}
              className="w-full py-3 rounded-xl bg-purple-700  text-white dark:bg-rose-500 dark:text-white font-semibold flex items-center justify-center gap-2 disabled:opacity-60"
            >
              <Send size={18} />
