      ...
      <div className="max-w-6xl mx-auto space-y-28">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Describe", desc: "Explain your app or website idea using natural language." },
              { title: "Generate", desc: "AI creates UI layouts, UX flows, and component structures." },
              { title: "Customize", desc: "Refine, iterate, and export production-ready designs." },
            ].map((item, i) => (
              <div
                key={i}
                className="
        ...
        <section className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Human-First AI", desc: "AI assists creativity, it never replaces judgment." },
              { title: "Speed with Clarity", desc: "Fast output without sacrificing UX principles." },
              { title: "Design for Scale", desc: "Everything we generate is built to grow." },
            ].map((v, i) => (
              <div
                key={i}
                className="
