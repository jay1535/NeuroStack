  ...
  return (
    ...
    >
      ...
      >
        <div
          className="
            ...
            hover:dark:dark:bg-purple-600 bg-purple-700 hover:bg-purple-900
            hover:pl-8
          "
        >
          ← Back
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold dark:text-purple-600 text-black">
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            "
          >
            <h3 className="text-lg font-semibold dark:text-purple-600 text-black">Free</h3>
          ...
          <motion.div
            ...
            className="
              ...
              bg-black/5 border border-purple-600/40
              dark:bg-white/5
              scale-[1.03]
            "
          >
            <span
              className="
                ...
                dark:bg-purple-600 bg-purple-700 text-white
              "
            >
              MOST POPULAR
            </span>

            <h3 className="text-lg font-semibold dark:text-purple-600 text-black">Pro</h3>
            ...
            <button
              className="
                mt-8 w-full
                px-6 py-3 rounded-xl
                dark:bg-purple-600 bg-purple-700 text-white font-semibold
                transition-all duration-300
                hover:dark:bg-purple-700 hover:bg-purple-700
